...
\begin{figure}[ht]
    ...
    \caption[UR10e Collaborative Robot and Robotiq 2F-140 Gripper]{UR10e Col
    Parabéns a todos e um agradecimento especial ao Prof. Filipe pelo esforço final que levou este artigo a ser publicado.
    laborative Robot \cite{UR10e_image} and Robotiq 2F-140 Gripper \cite{robotiq_gripper}}
    \label{fig:ur10e}
\end{figure}
